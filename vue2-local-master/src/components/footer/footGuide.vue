<template>
    <section id='foot_guide'>
        ...
        <section @click = "gotoAddress({path: '/photos', query: {category}})" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('msite') !== -1? '#msiteActive' : '#msite'"></use>
            </svg>
            <span>照片</span>
        </section>
        <section @click = "gotoAddress({path: '/videos'})" class="guide_item">
        	<svg class="icon_style">
        ...
        <section @click = "gotoAddress('/localTest')" class="guide_item">
        	<svg class="icon_style">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" :xlink:href="$route.path.indexOf('localTest') !== -1? '#orderActive' : '#order'"></use>
            </svg>
            <span>测试</span>
        </section>
    </section>
